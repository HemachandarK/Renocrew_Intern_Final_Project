    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="position: absolute;bottom: 0;right: 0;margin-bottom:10px" href="home">Log Out</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="release" method="post">
                        <div class="mb-3">
                            <label for="tab">Enter Table</label>
                            <input type="number" name="tab" id="tab" class="form-control" required>
                        </div>
